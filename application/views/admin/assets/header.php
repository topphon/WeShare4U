...
<header class='header-nav' id="header-nav">
  ...
  <nav style="float: right; padding-right:10%; font-size:16px;">
    <div>
      สวัสดี, คุณ<a style="margin-top:-10%; text-decoration: underline;" href="#"><?=" ".$fname." ".$lname?> (ผู้ดูแลระบบ)</a>
    </div>
...
<nav class="menu" style="margin-top: 5%;">
  <ul>
    <li><a class="hvr-underline-custom-left" href="<?=base_url()?>index.php/admin/index">หน้าเเรก</a></li>
    <li><a class="hvr-underline-custom-left" href="<?=base_url()?>index.php/admin/manageuser">จัดการผู้ใช้</a></li>
  </ul>
</nav>
