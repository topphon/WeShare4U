  ...
  <header class='header-nav' id="header-nav">
    <ul>
      ...
      <li style="float: right; padding-right:10%;">
        <a class="hvr-shutter-in-horizontal-custom cd-signin" style="margin-top:-2%;" name="signin-main" href="#">เข้าสู่ระบบ</a>
        <a style="margin-top:-14%; text-decoration: underline;" href="<?=base_url()?>index.php/home/signUp">สมัครสมาชิก</a>
      </li>
    </ul>
  </header>
