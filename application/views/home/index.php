  ...
  <header>
    <nav class='header-nav' id="header-nav">
      <ul>
        ...
        <li style="float: right; padding-right: 7%;"><a class="hvr-shutter-in-horizontal-custom cd-signin" name="signin-main" href="#0">เข้าสู่ระบบ</a></li>
      </ul>
    </nav>
  </header>
...
<div class="cd-user-modal"> <!-- modal form, including the background -->
  <div class="cd-user-modal-container" style="border-width:1px; border-style:dashed; border-color:#afccff;border-radius:25px;"> <!-- container wrapper -->
    ...
    <!-- <div id="cd-signup" >
      ...
      style="border-width:1px;border-style:dashed; border-color:#afccff;
      border-bottom-right-radius:25px; border-bottom-left-radius:25px;">
        ...
        <input type="checkbox" name="accept" onkeyup="clearAcceptError()"  required title="กรุณายอมรับข้อตกลง">
